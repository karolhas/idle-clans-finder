...
export default function AdvancedPlayerInfoModal({
  ...
  const handleItemClick = (itemName: string | null) => {
    if (itemName) {
      // Special case for Belt of the Moon
      if (itemName === "Belt of the Moon") {
              ...
              {[
                ...
                >
                  {group.map((slot) => {
                    ...
                    const equipmentId = playerData.equipment[slot];
                    ...
                    return (
                      ...
                      >
                        <div className="w-6 h-6 sm:w-8 sm:h-8 flex items-center justify-center">
                          {hasValidName && (
                            <Image
                              src={createSafeImagePath(boostName)}
                              alt={boostName}
                              width={32}
                              height={32}
                              className="w-full h-full object-contain"
