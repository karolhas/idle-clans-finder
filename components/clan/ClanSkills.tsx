...
export default function ClanSkills({ skills }: ClanSkillsProps) {
  ...
  return (
    <div className="bg-white/5 p-6 md:p-8 rounded-2xl border-2 border-white/10 backdrop-blur-xl shadow-xl hover:border-teal-500/50 hover:shadow-teal-900/20 transition-all duration-300 group">
