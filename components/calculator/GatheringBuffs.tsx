...
export default function GatheringBuffs() {
  ...
  return (
    <div className="bg-black/60 p-6 rounded-2xl border-2 border-white/10 relative backdrop-blur-md shadow-xl hover:border-teal-500/50 hover:shadow-teal-900/20 transition-all duration-300 group">
      ...
      <div className="mb-6">
        <h3 className="text-xs font-semibold text-emerald-400 uppercase tracking-wider mb-4 border-b border-white/5 pb-2">
          Gathering Buffs
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              readOnly
              className="w-full px-3 py-2.5 bg-black/60 border border-white/5 rounded-lg text-gray-300 cursor-not-allowed focus:outline-none"
            />
          </div>
