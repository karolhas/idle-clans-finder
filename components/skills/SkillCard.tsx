        ...
        const animate = (time: number) => {
            ...
            setStars((prevStars) =>
                prevStars.map((star) => ({
                    ...
                    x:
                        (star.x +
                            Math.sin(time * 0.0005 * star.speed) * 0.05 +
                            100) %
                        100,
                    y:
                        (star.y +
                            Math.cos(time * 0.0005 * star.speed) * 0.05 +
                            100) %
                        100,
        ...
        >
            ...
            {isMaxLevel && (
                <div className="absolute inset-0 overflow-hidden">
                    {/* Background gradient */}
                    <div
                        className={`absolute inset-0 bg-gradient-to-br ${getBackgroundGradient()} opacity-90`}
                    ></div>
                    ...
                    {/* Shimmer effect */}
                    <div
                        className={`absolute inset-0 bg-gradient-to-t from-transparent ${getShimmerColor()} z-4`}
                    ></div>
                </div>
            )}
            ...
            <div className="relative z-10">
                ...
                {isTrueMastery && (
                    <div
                        ...
                        style={{
                            background:
                                'linear-gradient(to right, rgba(107,0,0,0.3), rgba(157,0,0,0.4), rgba(107,0,0,0.3))',
                            borderRadius: '4px',
                            padding: '3px 5px',
                            position: 'relative',
                            overflow: 'hidden',
                    ...
                    >
                        ...
                        <div className="flex items-center justify-center gap-1.5">
                            <div
                                ...
                                style={{
                                    background:
                                        'radial-gradient(circle, rgba(255,0,0,1) 0%, rgba(200,0,0,1) 90%)',
