...
export default function LogsViewer({
  ...
  return (
    <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div className="relative overflow-hidden rounded-3xl border-2 border-emerald-700/30 bg-gradient-to-br from-[#001515] to-[#001212] p-4 md:p-8 shadow-[0_0_40px_rgba(16,185,129,0.1)]">
        ...
        <div className="relative z-10">
          ...
          <div className="flex justify-center mb-8">
            <div className="bg-white/5 p-1.5 rounded-xl inline-flex border border-white/10 backdrop-blur-md shadow-inner">
              <button
                type="button"
                onClick={() => {
                  setMode("player");
              ...
              <div className="relative group w-full max-w-2xl">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-12 pr-32 py-3 bg-white/5 border-2 border-white/10 rounded-xl text-base text-white placeholder-gray-500 focus:outline-none focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/50 transition-all duration-300 backdrop-blur-xl shadow-inner"
                    disabled={loading}
                  />
          ...
          {filteredLogs.length > 0 ? (
            <div className="rounded-xl border border-emerald-800/30 bg-white/5 overflow-hidden shadow-inner backdrop-blur-sm">
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                  <thead className="bg-emerald-950/20 text-emerald-100/90 text-xs md:text-sm uppercase tracking-wider">
                    <tr>
                      <th className="px-4 md:px-6 py-3 md:py-4 font-semibold border-b border-emerald-800/30">
                        #
                      </th>
                      {mode === "player" && (
                        <th className="px-4 md:px-6 py-3 md:py-4 font-semibold border-b border-emerald-800/30">
                  ...
                  <tbody className="divide-y divide-emerald-800/20 text-xs md:text-sm text-gray-300">
                    {filteredLogs.map((log, idx) => (
                      <tr
                        key={`${log.timestamp}-${idx}`}
                        className="hover:bg-emerald-600/5 transition-colors duration-150 group"
                      >
                        <td className="px-4 md:px-6 py-3 md:py-3.5 text-gray-500 font-mono text-[10px] md:text-xs">
                          {idx + 1}
                        </td>
                        {mode === "player" && (
                          <td className="px-4 md:px-6 py-3 md:py-3.5 text-emerald-300 font-medium">
                            {log.clanName ?? "—"}
                          </td>
                        )}
                        <td className="px-4 md:px-6 py-3 md:py-3.5 font-medium text-white group-hover:text-emerald-200 transition-colors">
                          {log.memberUsername ?? "Unknown"}
                        </td>
                        <td className="px-4 md:px-6 py-3 md:py-3.5 leading-relaxed">
                          {log.message}
                        </td>
                        <td className="px-4 md:px-6 py-3 md:py-3.5 text-gray-400 whitespace-nowrap text-[10px] md:text-xs">
